...
/*
 * FriendPostCard is a UI component displaying a card with a post headline,
 * title, image, and author received via props
 */
const FriendPostCard = ({ index, post }) => {
  ...
  return (
    <Card className={classes.root}>
      ...
      <CardActions>
        <Button component={Link} to={{pathname:'/friend_post/' + index, post: post}} size="small" color="primary">
          Read
        </Button>
